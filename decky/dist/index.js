...
function StatusCard({ status, busy, onRefresh }) {
    ...
    return (SP_JSX.jsxs("div", { style: { display: "flex", gap: "10px", alignItems: "flex-start", justifyContent: "space-between" }, children: [SP_JSX.jsxs("div", { style: { display: "flex", gap: "10px", alignItems: "flex-start", minWidth: 0 }, children: [SP_JSX.jsx("div", { style: {
                            width: "10px",
                            height: "10px",
                            borderRadius: "50%",
                            background: color,
                            marginTop: "5px",
                            flex: "0 0 auto",
                        } }), SP_JSX.jsxs("div", { children: [SP_JSX.jsx("div", { style: { color, fontWeight: 600 }, children: summary.title }), SP_JSX.jsx("div", { style: { fontSize: "12px", opacity: 0.78, lineHeight: 1.35 }, children: summary.detail })] })] }), SP_JSX.jsx("button", { type: "button", "aria-label": "Refresh status", title: "Refresh status", disabled: busy, onClick: onRefresh, style: {
                    width: "32px",
                    height: "32px",
                    flex: "0 0 auto",
                    display: "flex",
